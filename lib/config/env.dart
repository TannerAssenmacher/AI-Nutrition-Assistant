class Env {
  ...
  static const String edamamApiId =
      String.fromEnvironment('EDAMAM_API_ID', defaultValue: '');
  static const String edamamApiKey =
      String.fromEnvironment('EDAMAM_API_KEY', defaultValue: '');
  ...
  static const String googleApiKeyAndroid =
      String.fromEnvironment('GOOGLE_API_KEY_ANDROID', defaultValue: '');
  static const String googleApiKeyIos =
      String.fromEnvironment('GOOGLE_API_KEY_IOS', defaultValue: '');
  static const String googleApiKeyMacos =
      String.fromEnvironment('GOOGLE_API_KEY_MACOS', defaultValue: '');
